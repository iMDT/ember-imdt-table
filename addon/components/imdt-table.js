...
export default Ember.Component.extend(TableSearchableMixin, TableSortableMixin, TablePaginableMixin, {
  ...
  classNameBindings: ['content.isFulfilled:is-fulfilled', 'content.isPending:is-loading', 'content.isLoading:is-loading',
    'paginable:is-paginable', 'sortable:is-sortable', 'searchable:is-searchable'],
  ...
  processedColumns: Ember.computed('columns', 'columns.[]', function(){
    return this._setupColumns.call(this);
  }),
